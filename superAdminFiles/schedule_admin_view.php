<?php
 ...
 include_once'../includes/dbConnection.inc.php';
    ...
    <div class="alert alert-success" style="margin-top: 8px;">
        ...
        <strong style="font-style: italic;font-size: 16px;"><a href="adminPage.php">Home</a>/timetable/view</strong> : 
      </div>  					
			 <div class="alert alert-info alert-dismissible" style="margin-top: 18px;">
  ...
  <!-- =======================================
		End of div-col-xl-10(div2 of main body)
		====================================== -->
