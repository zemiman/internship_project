     ...
     ?>
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-1">
                      ...
                      <div class="alert alert-success" style="margin-top: 8px;">
                       ...
                       <strong style="font-style: italic;font-size: 16px;"><a href="userPage.php">Home</a>/timetable/view/department_wise</strong> : you can see or print schedule of each section.
