     ...
     ?>
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-1">
                      ...
                      <div class="alert alert-success" style="margin-top: 8px;">
                       ...
                       <strong style="font-style: italic;font-size: 16px;"><a href="adminPage.php">Home</a>/timetable/view/print_Timetable</strong> : you can view or print schedule of each section.
...
?>
        ...
        <span id="select" class="text-danger font-weight-bold"></span>         
            ...
            <div class="form-group col-sm-3" style="margin-bottom: 30px;">
                <button type="submit" name="submit" class="btn btn-success" style="padding: 8px 14px; margin-left: 10px; float: right;">View</button>
            </div>
