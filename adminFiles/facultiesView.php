     ...
     ?>
          ...
          <div class="row">
            ...
            <div class="alert alert-success" style="margin-top: 8px;">
              ...
              <strong style="font-style: italic;font-size: 17px;"><a href="adminPage.php">Home</a>/faculties/View</strong> : views with edit and delete Instructors and lab Assistants of this college.
          ...
          ?>
              ...
              <div class="form-group col-sm-4">
                <button type="submit" name="submit" class="btn btn-success" style="padding: 8px 18px; margin-left: 15px; float: right;">View</button>
              </div>
          ...
          if (isset($_POST['submit'])) {
           ...
           echo '<h6 style="text-align: center; font-style: italic; font-weight: bold; margin-top: 10px; color: #6666ff;">Lecturers of Department of '.$depName.'</h6>';
           echo '<table class="table table-striped table-bordered" id="tabledit" style="margin-top: 10px;">
            ...
            $sql2="SELECT * FROM faculties WHERE dep_id='".$depId."'";
...
<!-- <script src="//code.jquery.com/jquery.min.js"></script> -->
 ...
 <script type="text/javascript">
  ...
  if ( window.history.replaceState ) {
   ...
   $(document).ready(function(){
    $('#tabledit').Tabledit({
      url:'crudForlecturer.php',
    rowIdentifier: 'lec_id',
    autoFocus: true,
    editButton: true,
    restoreButton: false,
    buttons: {
      ...
      columns:{
        identifier: [0, "lec_id"],
        editable: [[1, "fname"], [2, "lname"], [3, "dep_id"], [4, "email"], [5, "role"], [6, "username"]]
