   ...
   ?>
       ...
       <div class="alert alert-success" style="margin-top: 8px;">
        ...
        <strong style="font-style: italic;font-size: 17px;"><a href="adminPage.php">Home</a>/blocksView</strong> : List of Blocks of <?php echo $collegeName;?>.
...
<script type="text/javascript">
  ...
  if ( window.history.replaceState ) {
   ...
   $(document).ready(function(){
    $('#tabledit').Tabledit({
      url:'crudForblocks.php',
    rowIdentifier: 'block_id',
    autoFocus: true,
    editButton: true,
    restoreButton: false,
    buttons: {
      ...
      columns:{
        identifier: [0, "block_id"],
        editable: [[1, "loc_id"], [2, "block_name"]]

      },
      
      onSuccess:function(data, textStatus, jqXHR){
        if (data.action=='delete') {
          $('#'+data.block_id).remove();
        }
