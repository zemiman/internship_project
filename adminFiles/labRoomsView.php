  ...
  <div class="alert alert-success" style="margin-top: 8px;">
      ...
      <strong style="font-style: italic;font-size: 17px;"><a href="adminPage.php">Home</a>/labRoomsView</strong> : List of lab Rooms of <?php echo $collegeName;?>.
      ...
      <tbody>
        ...
        $result2=mysqli_query($conn,$sql2);
          ...
          while ($row2=mysqli_fetch_assoc($result2)) {
           ...
           $sql3="SELECT * FROM lab_room WHERE block_id='".$blockId."'";
  ...
  if ( window.history.replaceState ) {
   ...
   $(document).ready(function(){
    ...
    buttons: {
      ...
      columns:{
        identifier: [0, "labrm_id"],
        editable: [[1, "lab_name"], [2, "block_id"]]
