   ...
   <div class="alert alert-success" style="margin-top: 8px;">
      ...
      <strong style="font-style: italic;font-size: 17px;"><a href="adminPage.php">Home</a>/semesterView</strong> : list of semester interval of <?php echo $collegeName;?>.
   ...
   <div style="overflow-x:auto;">
    <table class="table table-striped table-bordered" id="tabledit" style="margin-top: 10px;">
      ...
      <tbody>
        ...
        $effectiveDate = strtotime("-4 months", strtotime($currentDate));
...
<script type="text/javascript">
  ...
  if ( window.history.replaceState ) {
   ...
   $(document).ready(function(){
    $('#tabledit').Tabledit({
      url:'crudForsemester.php',
    rowIdentifier: 'semIn_id',
    autoFocus: true,
    editButton: true,
    restoreButton: false,
    buttons: {
      ...
      columns:{
        identifier: [0, "semIn_id"],
        editable: [[1, "startDate"], [2, "endDate"]]
