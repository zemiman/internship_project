     ...
     ?>
            ...
            <div class="alert alert-success" style="margin-top: 8px;">
              ...
              <strong style="font-style: italic;font-size: 17px;"><a href="adminPage.php">Home</a>/classRooms</strong> : add class rooms of each blocks.
   ...
   ?>
       ...
       <form method="POST" name="add_name" id="add_name" class="bg-light" style="margin-top: 40px; padding-top: 20px; padding-bottom: 30px; padding-left: 8px;" onsubmit="return form_Validation()">
    ...
    ?>
       ...
       <div class="form-group col-sm-9">
            <p style="font-style: italic; font-size: 16px; display: inline-block;margin-bottom:3px;">Block:</p>
        ...
        <span id="select2" class="text-danger font-weight-bold"></span>         
          ...
          <div class="form-group col-sm-10">
            <p style="font-style: italic; font-size: 16px; display: inline-block;margin-bottom:3px;">Class Room:[You can add more classes!]</p>
            <table class="table table-bordered" id="dynamic_field">
              <tr>
                <td><input type="text" name="name[]" id="name" class="form-control name_list" required="" autocomplete="off" placeholder="Enter Classroom Name" style="padding: 14px;"></td>
         ...
         if (isset($_POST['submit'])) {
          if ($_SERVER['REQUEST_METHOD']=='POST') {
            ...
            $classroomname=$_POST['name'];
            if (empty($block)||empty($classroomname)) {
              echo "<h3> You have forgetten unfilled field one or more. plse fill first!! </h3>";
              # code...
            }else{

                  $error=[];
                foreach ($classroomname as $value){ 

               $sql="SELECT * FROM class_room WHERE class_name='".$value."' AND block_id='".$block."'";
          ...
          $error='There is error!';
           ...
           break;
               ...
               foreach ($classroomname as $value) {
                    ...
                    // echo "<br>".$depId;
                    $result=mysqli_query($conn, "INSERT INTO class_room(class_name, block_id) VALUES('".mysqli_real_escape_string($conn, $value)."', '".$block."')");
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
      ...
      $('#add').click(function(){
         ...
         i++;
         $('#dynamic_field').append(' <tr id="row'+i+'"><td><input type="text" name="name[]" required="" id="name" class="form-control name_list" autocomplete="off" placeholder="Enter Classroom Name" style="padding: 14px;"></td><td><button name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');
