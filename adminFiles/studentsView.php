     ...
     ?>
            ...
            <div class="alert alert-success" style="margin-top: 8px;">
              ...
              <strong style="font-style: italic;font-size: 17px;"><a href="adminPage.php">Home</a>/sectionView</strong> : views with edit and delete of sections of this college.
...
?>
        ...
        <div class="form-group col-sm-3">
          <button type="submit" name="submit" class="btn btn-success" style="padding: 8px 12px; margin-left: 10px; float: right;">View</button>
        </div>
    ...
    if (isset($_POST['submit'])) {
     ...
     echo '<h4 style="text-align: center; font-style: italic; font-weight: bold; margin-top: 10px; color: #6666ff;">Sections of Department of '.$depName.'</h4>';
     ...
     echo '<table class="table table-striped table-bordered" id="tabledit" style="margin-top: 10px;">
      ...
      $sql2="SELECT * FROM groupofstudent WHERE dep_id='".$depId."'";
        ...
        while ($row2=mysqli_fetch_assoc($result2)) {
          ...
          echo '<tr>
                <td>'.$row2["st_id"].'</td>
                <td>'.$row2["batch_name"].'</td>
                 <td>'.$row2["section_name"].'</td>
                 <td>'.$row2["dep_id"].'</td>
  ...
  if ( window.history.replaceState ) {
   ...
   $(document).ready(function(){
    ...
    buttons: {
      ...
      columns:{
        identifier: [0, "st_id"],
        editable: [[1, "batch_name"], [2, "section_name"], [3, "dep_id"]]
