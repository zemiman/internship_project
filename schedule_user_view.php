 ...
 <nav class="navbar navbar-light bg-light">
  ...
  <div class="container">
      <div class="row">
           ...
           <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-1" style="height: 56vh;">            
                     
          </div>

          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-10">
            
            <div class="alert alert-success alert-dismissible" style="margin-top: 14px;">
      ...
      ?>        
          ...
          <span id="select1" class="text-danger font-weight-bold"></span>  
               ...
               <p style="font-size: 16px; font-style: italic; display: inline-block; margin-left: 8px;">  Dept:  </p>
               <!-- <div class="col-sm-5"> -->
  ...
  if (isset($_POST['submit'])) {
      ...
      if (empty($departmentId)||empty($collegeId)) {
...
<!-- </section> -->
 ...
 <hr style="margin-top: 120px;">
    ...
    <footer class="footer">
    <span class="text-right" style="margin-left: 4px; font-size: 15px;">
    <strong>Copyright &copy; 2018-2019.</strong> <a target="_blank" href="#">Our Website</a>
    </span>
    <span class="float-right" style="margin-right: 8px; font-size: 15px;">
...
<!-- STYLE FOR SCROLL TO TOP -->
 ...
 <!-- END OF SCRIPT AND STYLE FOR SCROLL TO TOP 
  ...
  function form_Validation() {
    ...
    if (collegeid=="") {
      document.getElementById('select1').innerHTML="*please select one item 1st!";
